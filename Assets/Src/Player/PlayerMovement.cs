...
public class PlayerMovement : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		Input.GetInstance().Player.Jump.performed += OnJumpPerformed;
	}
	...
	void Update()
	{
		...
		// Read new Input System values once per frame
		...
		// Consume the one-shot jump-press flag after QueueJump has had a chance to see it
	...
	private void OnControllerColliderHit(ControllerColliderHit hit)
	{
		...
		// Project velocity onto the plane of the surface we hit, removing the
		// component that was driving into the wall so you slide along it instead
		playerVelocity -= Vector3.Dot(playerVelocity, hit.normal) * hit.normal;
	}
